...
<div style="background-color: rgba(var(--global-theme-color-rgb), 0.1); border-left: 4px solid var(--global-theme-color); padding: 15px; border-radius: 5px; margin: 20px 0;">
  <p style="margin: 0; font-weight: 500;">🔔 I expect to graduate in <span style="color: #DC143C;">spring 2026</span> and am actively seeking tenure-track <span style="color: #DC143C;">assistant professor</span> positions. I am also very interested in industry collaborations. If you would like to discuss potential opportunities or share insights, please feel free to reach out via <a href="mailto:zilin.huang@wisc.edu">Email</a> or <a href="assets/img/icon/Wechat.jpg">WeChat</a>.</p>
</div>
